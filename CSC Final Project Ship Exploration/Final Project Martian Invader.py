    ...
    while myGlobalTries > 0:
        ...
        if password == (pw1):
            ...
            if beginRecoverySeq == "Yes":
                ...
                ShipExplorer()
                #if mansion completed:
                if currentRoom == r20: #make current room return as a global variable
                    ...
                    if beginSimSeq == "Yes":
                        ...
                        if beginSimSeq == "Yes":
                            #runs the game until the player successfully completes it 2-3 times in a row
                            while count < 2:
                                SimonGameSeq()
...
#############################################################################
#Death Function. Prints a skull. Can be replaced by a photo in the GUI later.
#############################################################################
