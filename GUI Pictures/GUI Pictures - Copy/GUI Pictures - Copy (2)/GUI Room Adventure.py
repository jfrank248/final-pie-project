###########################################################################################
# Name: Collin Corbett, Tyler Perryman
# Date: 3/31/2017
# Description: GUI Room Adventure Code. This code creates a text based exploration game.
#This game leaves much to the imagination with its chilling setting and text based
#exploration. The game consists of navigating the mansion to discover all of the collectible
#items. Some of the items are cleverly hidden in text and will not appear obvious. The game
#also includes 3 ways to quit. Two of them are death endings. The game is simple and straight
#forward. Navigate the mansion, collect items, build your own imaginative story, and
#try not to die.
###########################################################################################
...
#diversity of the game.
                r1 = Room("Main Hall", "mainhall.gif")
                r2 = Room("Reading Room", "readingRoom.gif")
                r3 = Room("Grand Library", "grandLibrary.gif")
                r4 = Room("Enchanting Room", "enchantingRoom.gif")
                r5 = Room("Study", "study.gif")
                r6 = Room("Kitchen", "kitchen.gif")
                r7 = Room("Lab", "lab.gif")
                r8 = Room("Bathroom", "bathroom.gif")
                r9 = Room("Bedroom", "bedroom.gif")
                r10 = Room("Living Room", "livingRoom.gif")
                r11 = Room("Master Bedroom", "masterBedroom.gif")
                r12 = Room("Library", "library.gif")
                r13 = Room("Grand Study", "grandStudy.gif")
                r14 = Room("Sactuary", "sanctuary.gif")
                r15 = Room("Boiler Room", "boilerRoom.gif")
                r16 = Room("Dining Room", "diningRoom.gif")
                r17 = Room("Wine Room", "wineRoom.gif")
                r18 = Room("Spider Haven", "spiderHaven.gif")
                r19 = Room("Torture Room", "tortureRoom.gif")
                r20 = Room("aBedroom", "aBedroom.gif")
                r21 = Room("Meat Locker", "meatLocker.gif")
                r22 = Room("guestBathroom", "guestbathroom.gif")
                r23 = Room("Guest Room", "guestRoom.gif")
                r24 = Room("Guest Study", "guestStudy.gif")
                r25 = Room("Grand Staircase Room", "grandStaircaseRoom.gif")
                r26 = Room("Cellar Room", "cellarRoom.gif")
                r27 = Room("Trash Room", "trashRoom.gif")                          
